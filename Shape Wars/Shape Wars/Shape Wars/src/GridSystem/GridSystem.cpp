...
void GridSystem::PopulateGrid()
{
	...
	cells[0][12]->GetComponent<CShape>().circle.setFillColor(sf::Color::Green);*/
}
...
void GridSystem::AddDebugElementsForCell(Entity& cell)
{
	...
	cell.Add<CShape>(m_cellRadius, 4, sf::Color(r, g, b,0), sf::Color(255, 255, 255), 1);
	cell.GetComponent<CShape>().circle.setPosition(cell.GetComponent<CTransform>().pos);
	cell.GetComponent<CShape>().circle.setRotation(sf::degrees(45));*/
}
